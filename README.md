...
###### Trabalho com codificação de layouts em PSD ou similares, criando websites usando HTML, CSS, JS, PHP, mySQL e às vezes Bootstrap :) Estou aprendendo Pythom, Ruby, Vue.js e React - além de amar o framework Electron. Também sou podcaster, criadora, divulgadora científica em astronomia e desenvolvedora do projeto Missão Exoplaneta.
